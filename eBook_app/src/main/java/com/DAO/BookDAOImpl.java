...
public class BookDAOImpl implements BookDAO {
    ...
    public boolean addBooks(BookDtls b) {
        boolean f=false;
        try{
            String sql="insert into book_dtls(bookname,author,price,bookCategory,Category,status,photo,email) values(?,?,?,?,?,?,?,?)";
	...
	public List<BookDtls> getNewBook() {
		...
		BookDtls b=null;
		try {
			String sql="select * from book_dtls where Category=? and status=? order by bookId DESC ";
			PreparedStatement ps=conn.prepareStatement(sql);
			ps.setString(1, "new");
	...
	public List<BookDtls> getBookByOld(String email, String cate) {
		...
		BookDtls b=null;
		try {
			String sql="select * from book_dtls where Category=? and email=?";
			PreparedStatement ps=conn.prepareStatement(sql);
			ps.setString(1,cate);
	...
	public boolean oldBookDelete(String email, String cate,int id) {
		boolean f=false;
		try {
			String sql="delete from book_dtls where Category=? and email=? and bookId=?";
			PreparedStatement ps=conn.prepareStatement(sql);
			ps.setString(1, cate);
			ps.setString(2, email);
			ps.setInt(3, id);
	...
	public List<BookDtls> getBookBySearch(String ch) {
		...
		BookDtls b=null;
		try {
			String sql="select * from book_dtls where bookname like ? or author like ? or Category like ? or bookCategory like ? and status=?";
			PreparedStatement ps=conn.prepareStatement(sql);
			ps.setString(1,"%"+ch+"%");
			ps.setString(2,"%"+ch+"%");
			ps.setString(3,"%"+ch+"%");
